...
% In SAL, there is one decision for each agent to make:
...
% Constant relating payoff (as feedback) to the change of the propensity/probability of the corresponding decision made
...
tc = 0.2 ; % temptation to cheat. (1+ tc) is the payoff of the defector agent if the other agent cooperated (tc < s + 1 and  tc < 1)
